...
class ComponentTest(ContainerBase):
    ...
    def asset_components_are_in_order(self, problems, order):
        """
        Assert that components appear in the order of their addition
        """
        problem_name = []
        for problem in problems:
            problem_name.append(problem.name)

        self.assertEquals(problem_name, order)
    ...
    def test_add_html_component(self):
        ...
        page = ContainerPage(self.browser, None)
        # Add components
        add_components(page, 'html', components)
        problems = page.xblocks[1:]
        # Assert that components appear in same order as added.
        self.asset_components_are_in_order(problems, components)
    ...
    def test_add_latex_html_component(self):
        ...
        page = ContainerPage(self.browser, None)
        # Add latex component
        add_component(page, 'html', component, is_advanced_problem=False)
        problem = page.xblocks[1]
    ...
    def test_common_problem_component(self):
        ...
        page = ContainerPage(self.browser, None)
        # Add components
        add_components(page, 'problem', components)
        problems = page.xblocks[1:]
