define([
    ...
    'js/models/course', 'js/models/group_configuration', 'js/models/group',
    ...
    _, AjaxHelpers, TemplateHelpers, Course, GroupConfigurationModel, GroupModel, GroupConfigurationCollection, 
    GroupCollection, GroupConfigurationDetailsView, GroupConfigurationsListView, GroupConfigurationEditorView,
    GroupConfigurationItemView, ExperimentGroupEditView, GroupList, ContentGroupDetailsView,
    ContentGroupEditorView, ContentGroupItemView, Notification, ViewHelpers
) {
    'use strict';
    var SELECTORS = {
